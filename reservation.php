...
<span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span>
			...
			<div class="row">
				<div class="col-md-6">
					<h3 align="center"><span class="label-primary" > Neela's Guest House</span></h1>
				</div>
				<div class="col-md-6">
				
					<h3 align="center"><font align="center"><span class="label-primary" >Room Number 1</span></font></h3>
				</div>
			</div>
			<br>
            <div class="container">
