<?php
 require_once('function.php');
    ...
    $to      = $username;
	$subject = 'The Confirmation_Project';
	$message = 'We have approved your request. Please go through the below link and login using your password.http://www.ohrms.esy.es/pasword_reset.php';
