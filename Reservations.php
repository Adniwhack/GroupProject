...
<?php 
	...
	$func->user_reserve($First_Name, $Last_Name, $Gender, $Country, $Contact, $Checkin, $Checkout);
                    ...
                    <form class="form-horizontal col-md-10 col-md-offset-1" role="form" align = "left" >
					   <legend>Enter reservation details for <?php echo $Room_name; ?></legend>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
								<input type="inputNumber" class="form-control" id="inputNumber" placeholder="00947777123456" name= "Country"/>
							</div>
						</div>
