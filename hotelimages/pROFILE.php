            ...
            <br> </br>
                ...
                <fieldset>
                    ...
                    <nav class="navbar navbar-top" role="navigation" >
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <form class="navbar-form navbar-left" role="search"  name="Room_availability" method="post" action="Rooms.php">
                                <label for="Check_in">Check in<span class="glyphicon glyphicon-calendar"></span>:</label>
                                <input type="date" id="for" class="form-control" name="Check_in">
                                <br></br>
                                <label for="Check_out">Check out<span class="glyphicon glyphicon-calendar"></span>:</label>
