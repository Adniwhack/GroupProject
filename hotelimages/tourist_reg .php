...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    $username =$password = $passwordc = $country = $address = $email = $DOB =$Gender= $FirstName = $LastName = $Contact =  "";
    ...
    if ($password == $passwordc) {
        ...
        $log->create_reg_user($email, $password, $Name, $address, $username, $Gender, $DOB);
    }
    else
    {
...
<span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span>
    ...
    <div class="container-fluid">
				...
				<div class="col-md-6">
                    ...
                    <br></br>
                    <form class="form-horizontal col-md-10 col-md-offset-1" role="form" align = "left" name="Customer_reg" method="post" action="<?php htmlspecialchars($_SERVER["PHP_SELF"]);?>">
					   <legend>Enter your registration details here</legend>
                        ...
                        <div class="form-group" align = "center">
                            ...
                            <div class="col-md-8">
								<input required type="inputName" class="form-control" id="inputName" name="FirstName" />
							</div>
						</div>
                        ...
                        <div class="form-group" align = "center">
                            ...
                            <div class="col-md-8">
								<input required type="inputName" class="form-control" id="inputName" name="LastName" />
							</div>
						</div>
                        ...
                        <input required type="date" id="for" class="form-control" name="DOB">
							</div>
						</div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
								<input required type="email" class="form-control" id="inputEmail3" placeholder="abc@xyz.com" name="email"/>
							</div>
						</div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
								<input required type="inputAddress" class="form-control" id="inputAddress" placeholder="No 10, Down Street, Colombo 10" name="address"/>
							</div>
						</div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
								<input required type="inputNumber" class="form-control" id="inputNumber" placeholder="00947777123456" name="contact" />
							</div>
						</div>
                        <div class="form-group" align = "center">
							<label for="inputName" class="col-md-4 control-label">
                            ...
                            <div class="col-md-8">
								<input required type="inputName" class="form-control" id="inputName" name = "username" />
							</div>
						</div>
                        <div class="form-group" >
                            ...
                            <div class="col-md-8">
								<input required type="inputPassword" class="form-control" id="inputName" name="password"/>
							</div>
						</div>
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-md-8">
								<input required type="inputPassword" class="form-control" id="inputName" name ="passwordc" />
							</div>
                ...
                <div class="input-group">
                    <input required type="text" id="recaptcha_response_field" name="recaptcha_response_field" class="form-control input-lg" /> <a class="btn btn-default input-group-addon" href="javascript:Recaptcha.reload()"><span class="icon-refresh"></span></a>
             ...
             <a class="btn btn-default input-group-addon recaptcha_only_if_audio" href="javascript:Recaptcha.switch_type('image')"><span class="icon-picture"></span></a>
                ...
                <noscript>
                    ...
                    <input required type="hidden" name="recaptcha_response_field" value="manual_challenge" />
                </noscript>
            </div>
