...
<div class="container-fluid">
    ...
    <div class="col-md-6">
        ...
        while ($data = mysql_fetch_array($res)){
            ...
            echo "<tr><td>".$room."</td><td>".$room_cost."</td><td>".$room_type."</td><td><img height=100 width=100 src=".$room_image."></td><td><a href='Reservations_hotel.php?room_id=".$room_address."'>Link</a></td></tr>";
        }
        ?>
                </tbody>
                </table>
