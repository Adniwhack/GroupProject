...
<body>
 <nav class="navbar navbar-default">
	...
	<ul class="nav nav-pills navbar-right">
     ...
     <form class="navbar-form" role="search"align = "center"  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
          ...
          if ($result->num_rows > 0) {
            ...
            */
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo "<tr><td>".$row["Room_id"]."</td>"."<td>".$row["Checkin"]."</td>"."<td>".$row["Checkout"]."</td>";
